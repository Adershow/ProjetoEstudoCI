			...
			<div class="sidebar-scroll">
				<nav >
					<ul class="nav">
						...
						<li><a href="<?=base_url('questoes')?>" class="active"><i class="fas fa-question"></i> <span>Lista de Questões</span></a></li>
							...
							<div class="panel-heading">
								...
								<div class="left" style="margin-top: 1.5%;">
									<div class="d-flex justify-content-center h-100">
										...
										<?php echo form_open('questoes/search', array('method'=>'post')); ?>
										<div class="searchbar">
											<input class="search_input" type="text" name="titulo" placeholder="Search...">
								...
								<tbody style="font-size: 18px;">
									<?php foreach ($Questoes as $key) { ?>
										<tr>
											...
											<td><?php foreach ($Topicos as $chave) {
												if($chave['id'] == $key['topicos_id']){
													echo $chave['nome'];
												} 
											}?>
										</td>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" style="font-size: 20px;" id="exampleModalLabel">Registre um Usuário</h5>
					...
					<div class="modal-body">
						<?php echo form_open('usuarios/add', array('method'=>'post')); ?>
						<div class="form-row">
