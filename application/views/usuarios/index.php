								...
								<div class="panel-heading">
									...
									<div class="left" style="margin-top: 1.5%;">
										<div class="d-flex justify-content-center h-100">
											...
											<?php echo form_open('usuarios/search', array('method'=>'post')); ?>
											<div class="searchbar">
									...
									<tbody style="font-size: 18px;">
										<?php foreach ($Usuarios as $key) { ?>
											<tr>
												...
												<td><?php if($key['adm'] == '1'){ echo 'sim';}else{echo 'não';}?></td>
												<td><?php echo form_open('usuarios/usuarioInt', array('method'=>'get')); ?><button class="btn btn-info" type="submit" name="id" value="<?php echo $key['id']; ?>" style="max-width: 80px; margin-top: 15px;">Acessar</button></form>
													...
													<?php echo form_open('usuarios/delete', array('method'=>'get'));?><button class="btn btn-danger" style="max-width: 80px; margin-top: 15px;" value="<?php echo $key['id']; ?>" name="id">Excluir</button></form>
												</td>
											</tr>
										<?php } ?>
									</tbody>
